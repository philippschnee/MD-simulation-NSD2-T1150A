...
while (count <= number_replicates):
 traj = mdt.load('/path_to_trajectory/production_NSD2_{}_{}_{}ns_{}.h5'.format(peptide, methylation_state, sim_time, count))
...
# calcualte SN2 Transition States
 ...
 print('number of SN2 frames in NSD2 {}me{} in replicate {}:'.format(peptide, methylation_state, count), len(INT))
