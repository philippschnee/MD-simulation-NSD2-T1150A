...
for i in range(number_replicates):
    folder = ('/path-to-trajectory/production_NSD2_{}_{}{}_{}_{}.h5'.format(Variant, Peptide, methylation_state, sim_time, i+1))
    print(folder)
